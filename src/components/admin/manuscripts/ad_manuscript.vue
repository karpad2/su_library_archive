  ...
  <md-card class="md-layout-item" v-if="dataReady">
      ...
      <div>
          ...
          <md-field>
           ...
           <md-field>
            <label for="seperator_name">{{gt('sepearator_name')}}</label>
            <md-input id="seperator_name" @change="change" v-model="newspaper.category" md-counter="100"></md-input>
          </md-field>
        
            <md-field>
              <b-form-select @change="change" v-model="newspaper.language"  :options="languages"></b-form-select> <flag  v-if="flagready" :flag="newspaper.language"/>  
            </md-field>
          <md-field>
